    ...
    <main>
        <section class="d-flex flex-column justify-content-start align-items-start" id="papersTwoHeader" style="padding-top: 4.8rem;">
            <div class="d-flex justify-content-start align-items-center">
                <img src="images/caslogo.png" style="width: 30%;" alt="">
                <h1 class="fw-bold" style="font-size: 4rem;">CAS</h1>
            </div>
            <div class="col-12">
            ...
            <div class="container mt-3">
                <form class="d-flex justify-content-start">
                    <input class="form-control me-2" style="border-radius: 20px;" type="search" placeholder="Search using name..." aria-label="Search">
                    <button class="btn btn-warning btn-sm cust-btn-yellow fs-4 fw-bold" style="border-radius: 20px;" type="submit">SEARCH</button>
                </form>
            </div>
            ...
            <div class="container mt-3">
                <div class="card my-3" style=" border: none;">
                    <div class="card-body" style="background-color: #F0F0F0;">
                        <h5 class="card-title fw-bold" style="color: #071160;">Name of Thesis Paper</h5>
                        <h6 class="card-subtitle mb-2 fw-bold" style="color: #d6a73d;">2020 - BSIT</h6>
